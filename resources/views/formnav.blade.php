...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark py-2" style="background-color:#212529 !important; ">
        <div class="container ">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="{{url('/')}}" style="text-decoration: none;"><span>ASSISTENCIA_REC</span></a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="{{url('/')}}">Accueil <span class="sr-only">(current)</span></a>
                    </li>
