...
<head>
    ...
    <!-- Webpage Title -->
    <title>Assistancia_rec | @yield('headtitle')</title>
    <!-- Styles -->
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark py-2" style="background-color:#121415 !important; ">
        <div class="container ">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="#" style="text-decoration: none;"><span>ASSISTANCIA</span></a>
    ...
    <!-- Copyright -->
<div class="copyright bg-gray mt-auto fixed-bottom">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
